...
const studentController = {
  get: async (req, res) => {
    try {
      const student = await studentModel.findAll({
        ...
        include:{model:teacherModel,attributes:["firstName"]}
  ...
  post: async (req, res) => {
    const payload = req.body;
    const student = new studentModel();
    student.regNumber = payload.regNumber;
    ...
    await student.save();
    await student.addTeacher(payload.teacher);
    res.json({
  ...
  put: async (req, res) => {
    try {
      ...
      await student.save();
      res.json({
        message: `student updated successfully at id ${id}`,
        student,
      });
    } catch (error) {
      console.log(error),
  ...
  delete: async (req, res) => {
    try {
      ...
      await student.destroy();
      res.json({
        message: `Student of id ${id} Deleted successfully `,
        student,
      });
