...
departmentRoutes.get("/Department/:id",departmentController.getSingleDepartment);
...
// Deleting Department
departmentRoutes.delete("/Department/:id", departmentController.deleteDepartment);
